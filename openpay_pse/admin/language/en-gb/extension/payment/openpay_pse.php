...
$_[ 'text_success' ]              = 'Success: You have modified Openpay PSE account details!';
$_[ 'text_openpay_pse' ] = '<a href="http://www.openpay.mx/" target="_blank"><img src="view/image/payment/openpay-logo.png" alt="Openpay" title="Openpay" style="border: 1px solid #EEEEEE;" /></a>';
$_[ 'text_test' ]                 = 'Test';
$_[ 'text_live' ]                 = 'Live';
$_[ 'text_authorization' ]        = 'Authorization';
$_[ 'text_charge' ]               = 'Charge';
$_[ 'text_title' ]           = 'Openpay PSE';
...
// Error 
$_[ 'error_permission' ]          = 'Warning: You do not have permission to modify payment: Openpay PSE!';
