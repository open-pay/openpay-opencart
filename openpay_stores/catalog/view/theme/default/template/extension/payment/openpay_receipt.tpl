            ...
            <div class="container container-receipt">
                <div class="row" style="padding: 10px 0 0 0;">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">	
                        ...
                        <img class="img-responsive center-block Logo_paynet" src="/catalog/view/theme/default/image/paynet_logo.png" alt="Paynet">
                    </div>	
                </div>
                ...
                <div class="row marketing">
                    ...
                    <div class="col-lg-12" style="text-align:center;">
                        <img src="/catalog/view/theme/default/image/openpay_stores.png" alt="Tiendas" class="tiendas">
                    </div>
                    ...
                    <div class="footer">
                        <img src="/catalog/view/theme/default/image/powered_openpay.png" alt="Powered by Openpay">
                    </div>
