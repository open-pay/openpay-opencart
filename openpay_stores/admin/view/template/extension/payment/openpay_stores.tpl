                    ...
                    <div class="tab-content">
                        <div class="tab-pane active " id="tab-api">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input id="radio-test-mode" type="radio" name="openpay_test_mode" value="0" <?php if( ! $openpay_test_mode )echo' checked'; ?> ><?php echo $text_no; ?>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="openpay_test_mode" value="1" <?php if( $openpay_test_mode )echo' checked'; ?> ><?php echo $text_yes; ?>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="openpay_test_merchant_id" value="<?php echo $openpay_test_merchant_id; ?>" class="form-control" id="input-test-merchant" placeholder="<?php echo $entry_test_merchant_id; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="openpay_test_secret_key" value="<?php echo $openpay_test_secret_key; ?>" class="form-control" id="input-test-secret" placeholder="<?php echo $entry_test_secret_key; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="input-test-public" class="form-control" name="openpay_test_public_key" placeholder="<?php echo $entry_test_public_key; ?>" value="<?php echo $openpay_test_public_key; ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="openpay_live_merchant_id" value="<?php echo $openpay_live_merchant_id; ?>" class="form-control" id="input-live-merchant" placeholder="<?php echo $entry_live_merchant_id; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="openpay_live_secret_key" value="<?php echo $openpay_live_secret_key; ?>" class="form-control" id="input-live-secret" placeholder="<?php echo $entry_live_secret_key; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="input-live-public" class="form-control" name="openpay_live_public_key" placeholder="<?php echo $entry_live_public_key; ?>" value="<?php echo $openpay_live_public_key; ?>" >
                        ...
                        <div class="tab-pane" id="tab-general">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="openpay_title" value="<?php echo $openpay_title; ?>" class="form-control" id="input-title" placeholder="<?php echo $entry_title; ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="openpay_geo_zone_id" id="select-geo-zone" class="form-control">
                                        <option value="0"><?php echo $text_all_zones; ?></option>
                                        <?php foreach ($geo_zones as $geo_zone) : ?>
                                        <option value="<?php echo $geo_zone['geo_zone_id']; ?>" <?php if( $geo_zone['geo_zone_id'] == $openpay_geo_zone_id ) echo ' selected'; ?> ><?php echo $geo_zone['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="openpay_stores_status" id="select-module-status" class="form-control">
                                        <option value="0" ><?php echo $text_disabled; ?></option>
                                        <option value="1" <?php if( $openpay_stores_status )echo' selected'; ?> ><?php echo $text_enabled; ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <?php endif; ?>
                                        <input type="text" id="input-total" class="form-control" name="openpay_total" value="<?php echo $openpay_total; ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="input-sort-order" class="form-control" name="openpay_stores_sort_order" value="<?php echo $openpay_stores_sort_order; ?>" >
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="input-deadline" class="form-control" name="openpay_deadline" value="<?php echo $openpay_deadline; ?>" >
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-status">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="openpay_new_status_id" id="select-new" class="form-control">
                                        <?php foreach( $order_statuses as $order_status ) : ?>
                                        <option value="<?php echo $order_status['order_status_id']; ?>" <?php if( $order_status['order_status_id'] == $openpay_new_status_id ) echo ' selected'; ?> ><?php echo $order_status['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="openpay_captured_status_id" id="select-captured" class="form-control">
                                        <?php foreach( $order_statuses as $order_status ) : ?>
                                        <option value="<?php echo $order_status['order_status_id']; ?>" <?php if( $order_status['order_status_id'] == $openpay_captured_status_id ) echo ' selected'; ?> ><?php echo $order_status['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
