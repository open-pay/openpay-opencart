...
class ControllerPaymentOpenpayCards extends OpenpayCardsController {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('payment/openpay_cards', 'token=' . $this->session->data['token'], 'SSL'),
        );

        $data['action'] = $this->url->link('payment/openpay_cards', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('payment/openpay_cards.tpl', $data));
    }
    ...
    public function install() {
        ...
        $this->model_payment_openpay_cards->createOrderTable();
        $this->model_payment_openpay_cards->createTransactionTable();
        $this->model_payment_openpay_cards->createCustomerTable();
    }

    public function uninstall() {
//        if ($this->config->get('openpay_uninstall_table')) {
//            $this->load->model('payment/openpay_cards');
//            $this->model_payment_openpay_cards->deleteOrderTable();
//            $this->model_payment_openpay_cards->deleteTransactionTable();
//            $this->model_payment_openpay_cards->deleteCustomerTable();
//        }
...
//        }
    ...
    public function orderAction() {
        if (defined('PRO_MOD') && PRO_MOD && isset($this->request->get['order_id']) && ( $charge = $this->fetchCharge($this->request->get['order_id']) )) {
            ...
            $data['txn'] = $this->model_payment_openpay_cards->getTransactions(array('charge_ref' => $charge->id));
            ...
            return $this->load->view('payment/openpay_cards_order.tpl', $data);
        }
    }
